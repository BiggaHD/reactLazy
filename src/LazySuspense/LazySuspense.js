...
import Loading from "../spinners/spinner.gif";

const Description = React.lazy(() => slowImport(import("./Description"), 500));
const Cast = React.lazy(() => slowImport(import("./Cast"), 500));
